# Hidden state prediction of discrete states for tips on a tree, based on empirical ancestral probabilities.
hsp_empirical_probabilities = function(	tree, 
	...
	asr_results = asr_empirical_probabilities(	tree			= known_subtree, 
