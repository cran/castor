# Squared-change parsimony hidden state prediction for a continuous trait, for tips on a tree.
hsp_squared_change_parsimony = function(tree, 
	...
	asr_results = asr_squared_change_parsimony(	known_subtree, 
