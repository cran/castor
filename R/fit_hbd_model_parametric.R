...
fit_hbd_model_parametric = function(tree, 
									...
									rho0,							# function handle, mapping model_parameters to the sampling fraction (aka. rarefaction), (param_values) --> rho. Must be defined for all parameters within the imposed bounds.
