...
generate_random_tree_CPP <- function(max_tips, max_time, birth_rate_intercept, birth_rate_factor, birth_rate_exponent, death_rate_intercept, death_rate_factor, death_rate_exponent, coalescent) {
    .Call('castor_generate_random_tree_CPP', PACKAGE = 'castor', max_tips, max_time, birth_rate_intercept, birth_rate_factor, birth_rate_exponent, death_rate_intercept, death_rate_factor, death_rate_exponent, coalescent)
}
...
simulate_Brownian_motion_model_CPP <- function(Ntips, Nnodes, Nedges, tree_edge, edge_length, root_states, diffusivity, include_tips, include_nodes, Nsimulations) {
    .Call('castor_simulate_Brownian_motion_model_CPP', PACKAGE = 'castor', Ntips, Nnodes, Nedges, tree_edge, edge_length, root_states, diffusivity, include_tips, include_nodes, Nsimulations)
}
